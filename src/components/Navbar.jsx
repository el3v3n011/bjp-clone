    ...
    <>
      <div className="flex  text-white justify-between ">
        <div className="p-2 flex ">
          ...
          <h3
            className=" font-bold text-3xl text-bjp-orange my-auto
             "
          >
        ...
        <div className="flex divide-x-2  my-auto ">
          ...
          <div className="px-2 hover:text-bjp-orange"> HAM LIVE</div>
          <div className=""></div>
           
        </div>
        <div className="flex px-2 ">

          <button className=" bg-bjp-orange m-5 px-10 rounded  "> JOIN HAM</button>
